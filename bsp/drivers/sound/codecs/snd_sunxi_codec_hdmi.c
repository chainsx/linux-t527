...
static int sunxi_hdmi_plugin_notifier(struct notifier_block *nb, unsigned long event, void *ptr)
{
...
static int sunxi_hdmi_extcon_init(struct sunxi_codec *codec)
{
	int ret;
...
static void sunxi_hdmi_extcon_exit(struct sunxi_codec *codec)
{
	struct sunxi_hdmi_extcon *hdmi_extcon;
...
static int snd_sunxi_hdmi_add_controls(struct snd_soc_component *component)
{
	int ret;
	struct sunxi_codec *codec = snd_soc_component_get_drvdata(component);
...
static int snd_sunxi_hdmi_init(void)
{
	int ret;
...
static int snd_sunxi_hdmi_hw_params(struct snd_pcm_hw_params *params,
			     enum HDMI_FORMAT hdmi_fmt)
{
...
static int snd_sunxi_hdmi_prepare(void)
{
	static hdmi_audio_t *hdmi_para = &g_hdmi_priv.hdmi_para;
...
static void snd_sunxi_hdmi_shutdown(void)
{
	SND_LOG_DEBUG("\n");
...
static int __init sunxi_hdmi_codec_dev_init(void)
{
	int ret;
...
static void __exit sunxi_hdmi_codec_dev_exit(void)
{
