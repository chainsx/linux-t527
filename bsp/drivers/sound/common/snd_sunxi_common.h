...
enum SND_SUNXI_PACFG_STA {
	SND_SUNXI_PACFG_STA_NULL = -1,
	SND_SUNXI_PACFG_STA_OPEN = 0,
	SND_SUNXI_PACFG_STA_CLOSE,
	SND_SUNXI_PACFG_STA_STOP,
};
...
struct snd_sunxi_pacfg {
	...
	struct delayed_work pa_en_work;
	struct delayed_work pa_disa_work;
	enum SND_SUNXI_PACFG_STA status;
