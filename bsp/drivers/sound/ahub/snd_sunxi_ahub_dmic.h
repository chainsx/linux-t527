...
#ifndef __SND_SUNXI_AHUB_DMIC_H
#define __SND_SUNXI_AHUB_DMIC_H
...
#define SUNXI_DMIC_CTL			0x08
#define SUNXI_DMIC_INTC			0x14
#define SUNXI_DMIC_INTS			0x18
#define SUNXI_DMIC_FIFO_CTL		0x1C
...
#define	SUNXI_DMIC_HPF_CTL		0x38
...
#define FIFO_UNDERRUN_IRQ_EN		0
/* SUNXI_DMIC_INTS */
#define FIFO_OVERRUN_IRQ_PENDING	1
#define FIFO_UNDERRUN_IRQ_PENDING	0
/* SUNXI_DMIC_FIFO_CTL */
#define DMIC_FIFO_MODE			9
#define DMIC_SAMPLE_RESOLUTION		8
/* SUNXI_DMIC_FIFO_STA */
#define DMIC_DATA_FULL			9
#define DMIC_DATA_EMPTY			8
#define DMIC_DATA_WL			0
/* SUNXI_DMIC_CH_NUM */
