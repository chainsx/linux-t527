...
extern nvram_info_t nvram_info;
...
void get_userconfig_txpwr_lvl(txpwr_idx_conf_t *txpwr_lvl);
...
int pcie_plat_bin_fw_upload_android(struct rwnx_hw *rwnx_hw, u32 fw_addr, const char *filename);
