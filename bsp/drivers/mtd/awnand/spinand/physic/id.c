...
struct aw_spinand_phy_info gigadevice[] = {
	...
	{
		.Model          = "GD5F8GM8REYIG",
		.NandID         = {0xc8, 0x89, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff},
		.DieCntPerChip  = 1,
		.SectCntPerPage = 8,
		.PageCntPerBlk  = 64,
		.BlkCntPerDie   = 4096,
		.OobSizePerPage = 64,
		.OperationOpt   = SPINAND_QUAD_READ | SPINAND_QUAD_PROGRAM |
			SPINAND_DUAL_READ | SPINAND_POWER_1V8,
		.MaxEraseTimes  = 50000,
		.EccFlag        = HAS_EXT_ECC_SE01,
		.EccType        = BIT4_LIMIT6_TO_7_ERR8_LIMIT_12,
		...
		struct aw_spinand_phy_info *pinfo)
{
	...
	sunxi_info(NULL, "ecc_status_shift:    %d\n", pinfo->ecc_status_shift);
